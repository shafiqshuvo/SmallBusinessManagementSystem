...
INSERT INTO Supplier(Code, Name, Address, Email, Contact, ContactPerson) VALUES ('1003', 'Nasrin TElecom', 'Dhanmondi', 'nasrimabcd@gmail.com', '01527478885','01763839732');
...
INSERT INTO Sales(Date, Customer, Category, Product, Quantity, MRP) VALUES ('03-OCT-1999', '1000', '1001', '1000', '15', '200');
INSERT INTO Sales(Date, Customer, Category, Product, Quantity, MRP) VALUES ('2019-12-09', '1000', '1003', '1004', '2', '200');
INSERT INTO Sales(Date, Customer, Category, Product, Quantity, MRP) VALUES ('2019-08-03', '1003', '1000', '1002', '3', '200');
INSERT INTO Sales(Date, Customer, Category, Product, Quantity, MRP) VALUES ('2019-07-13', '1004', '1000', '1003', '1', '300');
INSERT INTO Sales(Date, Customer, Category, Product, Quantity, MRP) VALUES ('2019-07-23', '1001', '1003', '1004', '1', '100');
INSERT INTO Sales(Date, Customer, Category, Product, Quantity, MRP) VALUES ('2019-07-23', '1001', '1001', '1003', '18', '20');
...
INSERT INTO Purchase(InvoiceNo, Date, Supplier, Category, Product, ManufactureDate,ExpireDate, Quantity, UnitPrice, MRP, Remarks) VALUES ('2929cc',   '2019-07-23', '1002', '1001', '1005','2005-02-11', '2009-02-11', '250',  '70000', '90000', 'Sell kom lav besi.');
INSERT INTO Purchase(InvoiceNo, Date, Supplier, Category, Product, ManufactureDate,ExpireDate, Quantity, UnitPrice, MRP, Remarks) VALUES ('29287pc',  '2019-08-23', '1003', '1000', '1000','2000-02-11', '2007-01-01', '500',  '7000',  '9500',  'Sell besi lav kom.');
--INSERT INTO Purchase(InvoiceNo, Date, Supplier, Category, Product, ManufactureDate,ExpireDate, Quantity, UnitPrice, MRP, Remarks) VALUES ('77729cc',  '2018-07-29', '1003', '1000', '1003','20010-02-11', '2019-08-01', '550',  '2000',  '5000',  'Sell besi lav besi.');
--INSERT INTO Purchase(InvoiceNo, Date, Supplier, Category, Product, ManufactureDate,ExpireDate, Quantity, UnitPrice, MRP, Remarks) VALUES ('292589cy', '2018-07-23', '1004', '1003', '1004','20013-02-11', '2005-07-21', '750',  '500',   '1000',  'Sell besi lav mondo na.');
INSERT INTO Purchase(InvoiceNo, Date, Supplier, Category, Product, ManufactureDate,ExpireDate, Quantity, UnitPrice, MRP, Remarks) VALUES ('aa29cc',   '2019-01-03', '1001', '1000', '1002','2004-02-11', '2010-02-01', '1050', '25000', '45000', 'Sell kom lav valoi.');
INSERT INTO Purchase(InvoiceNo, Date, Supplier, Category, Product, ManufactureDate,ExpireDate, Quantity, UnitPrice, MRP, Remarks) VALUES ('888829cc', '2019-07-23', '1002', '1001', '1005', '2001-02-11','2009-02-11', '250',  '70000', '90000', 'Sell kom lav besi.');
INSERT INTO Purchase(InvoiceNo, Date, Supplier, Category, Product, ManufactureDate,ExpireDate, Quantity, UnitPrice, MRP, Remarks) VALUES ('u9l29cc',  '2019-05-23', '1002', '1000', '1003','2007-02-11', '2009-02-11', '1',    '70000', '90000', 'Sell kom lav besi.');
...
----------- Stock Periodical Modified By Shafiq ------------
CREATE VIEW StockIn
AS
...
StockIn.[In] + ((StockIn.[In] - StockOut.[Out])) As 'Openning Balance',StockIn.[In] As 'In',StockOut.[Out] AS 'Out', (StockIn.[In] - StockOut.[Out]) AS 'Closing Balance', StockOut.[Out Date] AS 'EndDate'
FROM StockIn
...
As
SELECT MIN( Code) As 'Code', Name As 'Name', SalesView.Category As 'Category',Min(Date) As Date, SUM( Quantity) AS 'Quantity',SUM (MRP*Quantity) As 'TotalMRP',
Sum( PerUnitPrice.Unitprice*Quantity) As 'totalUnitPrice', SUM((MRP*Quantity)-(PerUnitPrice.Unitprice*Quantity))As Profit FROM SalesView
