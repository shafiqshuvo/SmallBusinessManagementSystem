...
namespace SmallBusinessManagementSystem.Manager
{
    public class SalesManager
    {
        ...
        public bool IsReorderLevelReached(SalesModel salesModel)
        {
            double inStock = GetAvailableQuantity(salesModel.Category, salesModel.Product);
            double reorderLevel = _salesRepository.GetReorderLevel(salesModel);
